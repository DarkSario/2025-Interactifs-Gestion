...
**Nombre total de tables détectées:** 43
...
- **event_module_data**: 57 colonnes, référencée dans 3 fichier(s)
...
- **sqlite_master**: 92 colonnes, référencée dans 9 fichier(s)
...
### Table: `article_purchase_batches`

**Colonnes détectées:**

- `achat_id` (type inféré: INTEGER)
- `article_id` (type inféré: INTEGER)
- `id` (type inféré: INTEGER)
- `quantity` (type inféré: TEXT)
- `remaining_quantity` (type inféré: TEXT)
- `scope` (type inféré: TEXT)
...
- `close_after` (type inféré: TEXT)
- `committed` (type inféré: TEXT)
- `converter` (type inféré: TEXT)
- `float` (type inféré: TEXT)
- `id` (type inféré: INTEGER)
- `int` (type inféré: TEXT)
- `name` (type inféré: TEXT)
- `operations` (type inféré: TEXT)
- `retries` (type inféré: TEXT)
- `rows` (type inféré: TEXT)
- `rows_affected` (type inféré: TEXT)
- `rows_updated` (type inféré: TEXT)
...
- `ALLOWED_TABLES` (type inféré: TEXT)
- `article` (type inféré: TEXT)
- `article_id` (type inféré: INTEGER)
- `categorie` (type inféré: TEXT)
- `check_table` (type inféré: TEXT)
...
- `lines_table_candidates` (type inféré: TEXT)
- `name` (type inféré: TEXT)
- `new_quantity` (type inféré: TEXT)
- `new_stock` (type inféré: INTEGER)
- `purchase_price` (type inféré: TEXT)
- `quantite` (type inféré: INTEGER)
- `reason` (type inféré: TEXT)
- `rows` (type inféré: TEXT)
- `snapshot` (type inféré: TEXT)
- `stock` (type inféré: INTEGER)
- `type` (type inféré: TEXT)
- `unite` (type inféré: TEXT)
- `unite_type` (type inféré: TEXT)
...
- `article` (type inféré: TEXT)
- `article_categorie` (type inféré: TEXT)
- `article_cb` (type inféré: TEXT)
- `article_contenance` (type inféré: TEXT)
- `article_data` (type inféré: TEXT)
- `article_id` (type inféré: INTEGER)
- `article_list` (type inféré: TEXT)
- `article_name` (type inféré: TEXT)
- `article_var` (type inféré: TEXT)
- `articles` (type inféré: TEXT)
- `articles_dict` (type inféré: TEXT)
- `articles_dicts` (type inféré: TEXT)
- `btn_frame` (type inféré: TEXT)
- `callback` (type inféré: TEXT)
- `categorie` (type inféré: TEXT)
- `commentaire` (type inféré: TEXT)
- `contenance` (type inféré: TEXT)
- `contenance_options` (type inféré: TEXT)
- `cur` (type inféré: TEXT)
- `display_str` (type inféré: TEXT)
- `edit_data` (type inféré: TEXT)
- `existing` (type inféré: TEXT)
- `existing_dict` (type inféré: TEXT)
- `existing_frame` (type inféré: TEXT)
- `id` (type inféré: INTEGER)
- `inv_id` (type inféré: INTEGER)
- `inventaire_id` (type inféré: INTEGER)
- `mode_frame` (type inféré: TEXT)
- `mode_var` (type inféré: TEXT)
- `name` (type inféré: TEXT)
- `new_categorie_var` (type inféré: TEXT)
- `new_contenance_cb` (type inféré: TEXT)
- `new_contenance_var` (type inféré: TEXT)
- `new_frame` (type inféré: TEXT)
- `new_name_var` (type inféré: TEXT)
- `purchase_price` (type inféré: TEXT)
- `purchase_price_var` (type inféré: TEXT)
- `qty_frame` (type inféré: TEXT)
- `quantite` (type inféré: INTEGER)
- `quantite_var` (type inféré: INTEGER)
- `rows` (type inféré: TEXT)
- `selected` (type inféré: TEXT)
- `stock` (type inféré: INTEGER)
- `succès` (type inféré: TEXT)
- `unite` (type inféré: TEXT)
...
- `(inv_id` (type inféré: INTEGER)
- `(inventaire_id` (type inféré: INTEGER)
- `(new_remaining` (type inféré: TEXT)
- `(qty` (type inféré: TEXT)
- `(table_name` (type inféré: TEXT)
- `)` (type inféré: TEXT)
- `)).fetchall()` (type inféré: TEXT)
- `0)` (type inféré: TEXT)
- `?` (type inféré: TEXT)
...
- `a.name` (type inféré: TEXT)
- `achat_id` (type inféré: INTEGER)
- `achat_id=None` (type inféré: TEXT)
- `article_id` (type inféré: INTEGER)
- `article_id)` (type inféré: TEXT)
- `article_id):` (type inféré: TEXT)
...
- `inventaire_id` (type inféré: INTEGER)
- `inventaire_id):` (type inféré: TEXT)
- `lines_table_candidates=None):` (type inféré: TEXT)
- `new_quantity)` (type inféré: TEXT)
- `new_stock)` (type inféré: TEXT)
- `pour` (type inféré: TEXT)
- `purchase_date` (type inféré: TEXT)
- `qty):` (type inféré: TEXT)
- `quantite` (type inféré: INTEGER)
- `quantity` (type inféré: INTEGER)
- `reason=None):` (type inféré: TEXT)
- `remaining_quantity` (type inféré: INTEGER)
- `scope` (type inféré: TEXT)
- `scope)` (type inféré: TEXT)
- `scope))` (type inféré: TEXT)
- `scope)).fetchall()` (type inféré: TEXT)
- `scope='buvette'):` (type inféré: TEXT)
- `skipping"` (type inféré: TEXT)
- `unit_price` (type inféré: REAL)
- `unit_price={unit_price}"` (type inféré: TEXT)
- `use` (type inféré: TEXT)
- `}` (type inféré: TEXT)
...
- `anchor` (type inféré: TEXT)
- `best_match` (type inféré: TEXT)
- `best_score` (type inféré: TEXT)
- `bg` (type inféré: TEXT)
- `bool` (type inféré: TEXT)
...
- `missing_with_matches` (type inféré: TEXT)
- `name` (type inféré: TEXT)
...
*Aucune colonne spécifique détectée (possiblement SELECT \*)*
...
- `col1` (type inféré: TEXT)
- `col2` (type inféré: TEXT)
- `col3` (type inféré: TEXT)
- `pattern` (type inféré: TEXT)
