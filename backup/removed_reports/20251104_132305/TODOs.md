...
Generated: 2025-11-04T11:22:43.062234
...
- [ ] modules/buvette.py:461
  ```python
  quantite_display = item.get("quantite", "")
  ```

- [ ] modules/buvette.py:465
  ```python
  iid=item.get("id", 0),
  ```

- [ ] modules/buvette.py:467
  ```python
  item.get("name", ""),
  ```

- [ ] modules/buvette.py:468
  ```python
  item.get("categorie", ""),
  ```

- [ ] modules/buvette.py:469
  ```python
  item.get("stock", 0),
  ```

- [ ] modules/buvette.py:472
  ```python
  item.get("contenance", ""),
  ```

- [ ] modules/buvette.py:473
  ```python
...
- [ ] scripts/apply_migrations.py:193
  ```python
  conn = sqlite3.connect(str(db_path))
  ```

- [ ] scripts/safe_add_columns.py:266
  ```python
  conn = sqlite3.connect(str(db_path))
  ```
...
- [ ] scripts/find_missing_columns.py:49
  ```python
  conn = sqlite3.connect(str(db_path))
  ```

- [ ] scripts/find_missing_columns.py:273
  ```python
  conn = sqlite3.connect(str(db_path))
  ```
